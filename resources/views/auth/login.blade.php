    ...
    <div class="glass-card rounded-3xl p-8 relative overflow-hidden" :class="{ 'border-rose-500/30 shake': errorShake }">
        ...
        <div x-show="!show2FA" class="relative z-10 space-y-4">
            ...
            <div class="grid grid-cols-3 gap-2">
                <button type="button" @click="triggerSSO('Google')" class="rounded-md border border-brand-teal/20 hover:border-brand-cyan/40 bg-brand-dark-secondary/40 py-2.5 flex items-center justify-center text-xs text-brand-white hover:bg-brand-dark-primary/60 transition-all cursor-pointer">
                    <span class="mr-1">🌐</span> Google
                </button>
                <button type="button" @click="triggerSSO('Apple')" class="rounded-md border border-brand-teal/20 hover:border-brand-cyan/40 bg-brand-dark-secondary/40 py-2.5 flex items-center justify-center text-xs text-brand-white hover:bg-brand-dark-primary/60 transition-all cursor-pointer">
                    <span class="mr-1">🍎</span> Apple
                </button>
                <button type="button" @click="triggerSSO('Microsoft')" class="rounded-md border border-brand-teal/20 hover:border-brand-cyan/40 bg-brand-dark-secondary/40 py-2.5 flex items-center justify-center text-xs text-brand-white hover:bg-brand-dark-primary/60 transition-all cursor-pointer">
                    <span class="mr-1">💻</span> Azure
                </button>
            </div>
